...
public class OrderServiceImpl implements IOrderService{
	...
	public ServerResponse payLogic(Long orderNO)
	{
		...
		return test_trade_precreate(order);
	...
	public ServerResponse alipay_callbackLogic(Map<String, String>map)
	{
		...
		if (orderDao.insertPayInfo(payInfo)) {
	...
	public ServerResponse  query_order_pay_statusLogic(Long orderNo)
	{
		...
		return ServerResponse.serverResponseByError(false);
	...
	///////////////////////////////////////////////////////////////////////////////////////
	 private static Log                  log = LogFactory.getLog(Main.class);
	    ...
	    public ServerResponse test_trade_precreate(Order order) {
	        ...
	        // 商品明细列表，需填写购买商品详细信息，
	        List<GoodsDetail> goodsDetailList = new ArrayList<GoodsDetail>();
	        List<OrderItem> orderItemLiset=orderDao.findOrderItemByOrderNo(order.getOrderNo());
	        if (orderItemLiset!=null&&orderItemLiset.size()>0) {
	        	for(OrderItem orderItem:orderItemLiset )
	        	{
	        		GoodsDetail goodsDetail=GoodsDetail.newInstance(String.valueOf(orderItem.getProductId()),orderItem.getProductName(),orderItem.getCurrentUnitprice().longValue(),orderItem.getQuantity());//没写
	        ...
	        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
	            ...
	            .setNotifyUrl("http://bck5f7.natappfree.cc/diandemo/OrderServlet?type=alipay_callback")//支付宝服务器主动通知商户服务器里指定的页面http路径,根据需要设置
