...
public class UserServlet extends HttpServlet {
	...
	public void login(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if(se.getStatus() == 0)
		{
			...
			request.getSession().setAttribute("userInfoId", userInfo.getId());
	...
	public void reset_password(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{//��¼ʱ��������
	...
	public void update_information(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{//��¼ʱ���¸�����Ϣ
		String email=request.getParameter("email");
		String phone=request.getParameter("phone");
		String question=request.getParameter("question");
		String answer=request.getParameter("answer");
	...
	public void get_inforamtion(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{//��ȡ��ǰ��¼�˵���Ϣ
		IUserService userService=new UserServiceImpl();
		String username = (String)request.getSession().getAttribute("flag");
