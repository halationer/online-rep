...
public class UserServletM extends HttpServlet {
	...
	private void delete(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		...
		ServerResponse res = service.mDeleteLogic(onlog, access, userid);
	...
	private void update(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		...
		String user = request.getParameter("userUpdate");
		System.out.println(user);
		UserTable userObj = new Gson().fromJson(user, UserTable.class);
		ServerResponse res = service.mUpdateLogic(onlog, access, userObj);
