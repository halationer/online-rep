                		...
                		$.ajax({
                			...
                			success: function(res){
                				if(res.status === 0){
    								...
    								$("#linkid13").attr('href','xiangqing.jsp?id='+list[0].id)
    								...
    								$("#linkid17").attr('href','xiangqing.jsp?id='+list[4].id)
                		...
                		$.ajax({
                			...
                			success: function(res){
                				if(res.status === 0){
    								...
    								$("#linkid21").attr('href','xiangqing.jsp?id='+list[0].id)
    								...
    								$("#linkid25").attr('href','xiangqing.jsp?id='+list[5].id)
                		...
                		$.ajax({
                			...
                			success: function(res){
                				if(res.status === 0){
    								...
    								$("#linkid28").attr('href','xiangqing.jsp?id='+list[0].id)
    								...
    								$("#linkid32").attr('href','xiangqing.jsp?id='+list[4].id)
