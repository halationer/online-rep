...
<!-- end banner_x -->
	...
	<div class="jieshao mt20 w">
		<div class="left fl"><a href="xiangqing.jsp" target="_blank"><img src="img/p1.jpg"  style="width:550px;height:550px;"></a></div>
		<div class="right fr">
			...
			<div class="daxiao" style="color: black;">输入加购数量：<input id="nums" type="text" placeholder="1" class="nums" value="1" /></div>
